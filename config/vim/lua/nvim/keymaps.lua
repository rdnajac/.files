...
require('which-key').add({
  ...
  { '<leader>dc', '<Cmd>ConformInfo<CR>', desc = 'Conform' },
  { '<leader>dk', '<Cmd>checkhealth which-key<CR>', desc = 'Keymaps' },
  ...
  -- { '<leader>fn', require('`file').title, desc = 'Add file title' },
  ...
  -- { '<leader>ft', function() require('old.goto').ft('plugin') end, desc = 'Edit after/ftplugin for current filetype', },
...
-- resize window using <option> arrow keys {{{1
...
-- https://github.com/mhinz/vim-galore#saner-behavior-of-n-and-n {{{1
